...
set init_verilog /home/isa16/lab1/advanced_architecture/netlist/IIR_FILTER_ADV.v
...
rcOut -setres IIR_FILTER_ADV.setres -rc_corner my_rc
rcOut -spf IIR_FILTER_ADV.spf -rc_corner my_rc
rcOut -spef IIR_FILTER_ADV.spef -rc_corner my_rc
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix IIR_FILTER_ADV_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix IIR_FILTER_ADV_postRoute -outDir timingReports
