input_file=fopen('../cmodel/resultsc_adv.txt','r');    %opening c model results file 
input_file2=fopen('../sim/results_vhdl_adv.txt','r');  %opening vhdl model results file 
...
scale_factor=4;   % set to 8 to compare the results of starting architecture
